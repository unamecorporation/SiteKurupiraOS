<?php require_once 'application/views/cabecalho.php'; ?>
        <!-- slide parallax -->
        <div class="parallax-container parallax-slide">
            ...
            <div class="parallax"><img src="assets/img/wallpaper.jpg"></div>
        </div>
        ...
        <article class="container">
            <div class="row">
                <div class="col s12 m7">
                    ...
                    <a href='http://unamecorp.com.br/kurupira/Kurupira-Live-x64.iso' class="waves-effect waves-light btn btn-k k-cian-darken font-bold hoverable">DOWNLOAD</a>
                </div>
                <div class="col hide-on-small-only m5">
                    <img class="responsive-img" src="assets/img/curupira.png">
                </div>
            </div>
        </article>
        ...
        <article class="container center">
            ...
            <div class="row">
                ...
                <div class="col s12 m4 k-cian-darken-text"> <!-- Familiridade -->
                    ...
                    <p class="flow-text black-text">
                        Por ser baseado em Debian(similar ao Kali, Parrot...) muitos usuários já estarão se sentido no localhost
                    </p>
                </div>
            </div>
        </article>
            ...
            <div class="container">
                <div class="row">
                    <div class="col s12 m8">
                        ...
                        <a href="documentacao/" class="btn-large btn-k k-cian-darken font-bold">
                            <i class="mdi mdi-file-document"></i> DOCUMENTAÇÃO
                        </a>
                    </div>
                </div>
            </div>
            <div class="parallax"><img src="assets/img/wallpaper3.jpg"></div>
        </article>
        ...
        <section class="center">
            ...
            <div class="carousel">
                <a class="carousel-item" href="#one!"><img src="assets/img/screenshots/principal.png"></a>
                <a class="carousel-item" href="#two!"><img src="assets/img/screenshots/config.png"></a>
                <a class="carousel-item" href="#three!"><img src="assets/img/screenshots/terminal.png"></a>
            </div>
        </section>
            ...
            <article class="row center">
                ...
                <div class="row">
                    <div class="col s6 m3"> <!-- Rafaela -->
                        <img class="circle responsive-img z-depth-2" src="assets/img/equipe/rafaela.jpg">
                    ...
                    <div class="col s6 m3"> <!-- Neto -->
                        <img class="circle responsive-img z-depth-2" src="assets/img/equipe/neto.jpg">
                        <h5 class="k-cian-darken-text font-bold">
                            Neto Chaves<br>
                        ...
                        <a href="https://github.com/netochaves" class="mdi mdi-github-box mdi-36px"></a>

                    </div>
                    <div class="col s6 m3"> <!-- Tristão -->
                        <img class="circle responsive-img z-depth-2" src="assets/img/equipe/ricardo.jpg">
                        <h5 class="k-cian-darken-text font-bold">
                            Ricardo Porfirio<br>
                    ...
                    <div class="col s6 m3"> <!-- Jesus -->
                        <img class="circle responsive-img z-depth-2" src="assets/img/equipe/jesus.jpg">
                        <h5 class="k-cian-darken-text font-bold">
                            Jesus<br>
                        ...
                        <a href="https://github.com/jesusfromhellz" class="mdi mdi-github-box mdi-36px"  target="_blank"></a>
                ...
                <div class="row">
                    <div class="col s6 m3"> <!-- Vandal -->
                        <img class="circle responsive-img z-depth-2" src="assets/img/equipe/vandal.jpg">
                        <h5 class="k-cian-darken-text font-bold">
                            Allan Garcez<br>
                    ...
                    <div class="col s6 m3"> <!-- Zero -->
                        <img class="circle responsive-img z-depth-2" src="assets/img/equipe/zero.jpg">
                        <h5 class="k-cian-darken-text font-bold">
                            Filipe Jessé<br>
                        ...
                        <a href="https://zero10101.github.io/" class="mdi mdi-github-box mdi-36px" target="_blank"></a>
                    ...
                    <div class="col s6 m3"> <!-- Roger -->
                        <img class="circle responsive-img z-depth-2" src="assets/img/equipe/roger.jpg">
                        <h5 class="k-cian-darken-text font-bold">
                            Roger Monteiro<br>
                        ...
                        <a href="https://github.com/RogerMonteiro124" class="mdi mdi-github-box mdi-36px" target="_blank"></a>

                    </div>
                    <div class="col s6 m3"> <!-- Luigi -->
                        <img class="circle responsive-img z-depth-2" src="assets/img/equipe/luigi.jpg">
                        <h5 class="k-cian-darken-text font-bold">
                            Guilherme Luigi<br>
                ...
                <div class="row">
                    <div class="col s6 m3"> <!-- Paulo -->
                        <img class="circle responsive-img z-depth-2" src="assets/img/equipe/paulo.jpg">
                        <h5 class="k-cian-darken-text font-bold">
                            Paulo<br>
                    ...
                    <div class="col s6 m3"> <!-- Rosângelo -->
                        <img class="circle responsive-img z-depth-2" src="assets/img/equipe/rosangelo.jpg">
                        <h5 class="k-cian-darken-text font-bold">
                            Rosângelo<br>
                            <spam class="font-thin">Fundador Eleva</spam>
                        </h5>
                    ...
                    <div class="col s6 m3"> <!-- Marcelo -->
                        <img class="circle responsive-img z-depth-2" src="assets/img/equipe/marcelo.jpg">
                        <h5 class="k-cian-darken-text font-bold">
                            Marcelo Freitas<br>
                        ...
                        <a href="https://www.linkedin.com/in/marceloeafreitas" class="mdi mdi-linkedin-box mdi-36px" target='_blank'></a>

                    </div>
                    <div class="col s6 m3"> <!-- Pizzo -->
                        <img class="circle responsive-img z-depth-2" src="assets/img/equipe/pizzo.jpg">
                        <h5 class="k-cian-darken-text font-bold">
                            Raphael Pizzo<br>
                ...
                <div class="row">
                    <div class="col s6 m3 offset-m3"> <!-- Flavio -->
                        <img class="circle responsive-img z-depth-2" src="assets/img/equipe/flavio.jpg">
                        <h5 class="k-cian-darken-text font-bold">
                            Flávio Henrique<br>
                        ...
                        <a href="https://www.linkedin.com/in/fl%C3%A1vio-henrique-de-almeida-junior-80a3b995/" class="mdi mdi-linkedin-box mdi-36px" target="_blank"></a>

                    </div>
                    <div class="col s6 m3"> <!-- Diego -->
                        <img class="circle responsive-img z-depth-2" src="assets/img/equipe/diego.jpg">
                        <h5 class="k-cian-darken-text font-bold">
                            Diego Costa<br>
        ...
        <footer class="page-footer k-red ">
            <div class="container center">
                <div class="row">
                  <?php
                    echo form_open('newslatter/cadastro', ['class'=>'col s12 m6 offset-m3']); ?>
                        <h3 class="k-cian-darken-text font-bold">Receba novidades do KurupiraOS!</h3>
                        <a name='uname-contact'/>
                        <div class="row white-text">
                            <div class="input-field inline">
                                <?= form_input('name', '', [
                                  ...
                                  <span style="color:#fff"><?= form_error('name')?></span>
                                <?= form_label('', 'name') ?>
                            </div>
                        </div>
                        <div class="row white-text">
                            <div class="input-field inline">
                              <?= form_input([
                                ...
                                <span style="color:#fff"><?= form_error('email')?></span>
                                <?= form_label('', 'email') ?>
                            </div>
                        </div>
                        <?php form_close();
        ...
        <script type="text/javascript" src="assets/js/init.js"></script> <!-- init functions -->
